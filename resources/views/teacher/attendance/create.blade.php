            ...
            <table class="w-full">
                <thead>
                    <tr class="bg-gray-50 text-gray-600 text-sm">
                        ...
                        <th class="px-4 py-3 text-center">حالة الحضور</th>
                    </tr>
                </thead>
                <tbody>
