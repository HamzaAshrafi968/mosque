        ...
        <table class="w-full">
            <thead>
                <tr class="bg-gray-50 text-gray-600 text-sm">
                    ...
                    <th class="px-4 py-3 text-right whitespace-nowrap">الرابط</th>
                ...
                @forelse($lessons as $lesson)
                    <tr>
                        ...
                        <td class="px-4 py-3 border-t">
                            @if($lesson->url)
                                <a href="{{ $lesson->url }}" target="_blank" class="text-emerald-700 hover:underline whitespace-nowrap">فتح الرابط</a>
                            @elseif($lesson->file_path)
                                <a href="{{ asset('storage/'.$lesson->file_path) }}" target="_blank" class="text-emerald-700 hover:underline whitespace-nowrap">تحميل الملف</a>
                            @else
                                —
                            @endif
                        </td>
