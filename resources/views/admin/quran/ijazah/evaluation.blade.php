...
<div class="max-w-2xl mx-auto space-y-6">
    ...
    <h2 class="text-2xl font-extrabold text-gray-800">تسجيل تقييم شهري</h2>
    <p class="text-sm text-gray-500">كل شهر يسجل تقييم واحد محفوظ تاريخياً ولا يُستبدل.</p>

    <form method="POST" action="{{ route('admin.quran.ijazah.evaluations.store') }}" class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 space-y-4">
        @csrf
        <div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div class="md:col-span-2">
                ...
                <input type="text" name="recited_portion" value="{{ old('recited_portion') }}" placeholder="مثال: القرآن كاملاً — الجزء 1 إلى 5" class="w-full border border-gray-300 rounded-lg px-3 py-2">
            </div>
            <div class="md:col-span-2">
        ...
        <div class="flex items-center justify-between pt-2">
            ...
            <a href="{{ route('admin.quran.ijazah.index') }}" class="text-gray-500 text-sm hover:underline">إلغاء</a>
        </div>
    </form>
</div>
@endsection
