...
<div class="max-w-5xl mx-auto space-y-4">
    ...
    @include('quran.listening.plan-form', [
        'pickerRoute' => route('admin.quran.listening.create'),
        'storeRoute' => route('admin.quran.listening.store'),
        'indexRoute' => route('admin.quran.batches.index'),
        'memorizationRoute' => $selectedStudent ? route('admin.quran.khamsa.create', ['student_id' => $selectedStudent->id]) : null,
    ])
</div>
@endsection
