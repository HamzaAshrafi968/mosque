...
<div class="space-y-6 max-w-5xl mx-auto">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 animate-scale-in">
        <div class="flex flex-wrap items-center gap-6">
            ...
            <div>
                <div class="text-xs text-gray-400">المعلم</div>
    ...
    <a href="{{ route('admin.quran-review.student-report', $session->student_id) }}" class="inline-flex items-center gap-2 bg-blue-600 text-white px-5 py-2.5 rounded-xl hover:bg-blue-700 transition font-medium shadow-lg shadow-blue-600/20 text-sm animate-fade-in-up">
        📊 تقرير الطالب كاملاً
    </a>
</div>
@endsection
