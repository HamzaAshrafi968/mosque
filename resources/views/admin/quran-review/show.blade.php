...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <div class="grid grid-cols-2 md:grid-cols-5 gap-4">
            ...
            <div>
                <div class="text-sm text-gray-500">المعلم</div>
            ...
            <div>
                <div class="text-sm text-gray-500">الآيات</div>
    ...
    <a href="{{ route('admin.quran-review.student-report', $session->student_id) }}" class="inline-block bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition text-sm">
        تقرير الطالب كاملاً
    </a>
</div>
@endsection
