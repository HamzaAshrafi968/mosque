...
/**
 * تقييم أسبوعي داخل شهر برنامج الإجازة (4 أسابيع لكل شهر).
 * القاعدة الحاسمة للإكمال تبقى على ijazah_monthly_evaluations.
 */
class IjazahWeeklyEvaluation extends Model
{
